...
public final class JmhPerfTest_textRewriteQueryParameter_jmhTest {
    ...
    public BenchmarkTaskResult textRewriteQueryParameter_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_jmhperftest0_G.textRewriteQueryParameter(l_mystate2_1);
                res.allOps++;
            }

            textRewriteQueryParameter_thrpt_jmhStub(control, res, l_mystate2_1, l_jmhperftest0_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "textRewriteQueryParameter", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void textRewriteQueryParameter_thrpt_jmhStub(InfraControl control, RawResults result, JmhPerfTest_MyState_jmhType l_mystate2_1, JmhPerfTest_jmhType l_jmhperftest0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult textRewriteQueryParameter_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            JmhPerfTest_jmhType l_jmhperftest0_G = _jmh_tryInit_f_jmhperftest0_G(control, threadParams);
            ...
            textRewriteQueryParameter_avgt_jmhStub(control, res, l_mystate2_1, l_jmhperftest0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jmhperftest0_G.textRewriteQueryParameter(l_mystate2_1);
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "textRewriteQueryParameter", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void textRewriteQueryParameter_avgt_jmhStub(InfraControl control, RawResults result, JmhPerfTest_MyState_jmhType l_mystate2_1, JmhPerfTest_jmhType l_jmhperftest0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult textRewriteQueryParameter_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            JmhPerfTest_jmhType l_jmhperftest0_G = _jmh_tryInit_f_jmhperftest0_G(control, threadParams);
            ...
            textRewriteQueryParameter_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_mystate2_1, l_jmhperftest0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jmhperftest0_G.textRewriteQueryParameter(l_mystate2_1);
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "textRewriteQueryParameter", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void textRewriteQueryParameter_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JmhPerfTest_MyState_jmhType l_mystate2_1, JmhPerfTest_jmhType l_jmhperftest0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult textRewriteQueryParameter_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            JmhPerfTest_jmhType l_jmhperftest0_G = _jmh_tryInit_f_jmhperftest0_G(control, threadParams);
            JmhPerfTest_MyState_jmhType l_mystate2_1 = _jmh_tryInit_f_mystate2_1(control, threadParams);
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            textRewriteQueryParameter_ss_jmhStub(control, batchSize, res, l_mystate2_1, l_jmhperftest0_G, l_blackhole1_0);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "textRewriteQueryParameter", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void textRewriteQueryParameter_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JmhPerfTest_MyState_jmhType l_mystate2_1, JmhPerfTest_jmhType l_jmhperftest0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
